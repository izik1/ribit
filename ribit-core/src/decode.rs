...
use crate::{opcode, register, DecodeError, Width};
...
pub fn instruction(instruction: u32) -> Result<Instruction, DecodeError> {
    ...
    let instruction = match (opcode, funct3, funct7) {
        (0b110_1111, _, _) => {
            Instruction::J(instruction::J::from_instruction(instruction, opcode::J::JAL))
        }

        (0b001_0111, _, _) => {
            Instruction::U(instruction::U::from_instruction(instruction, opcode::U::AUIPC))
        }

        (0b0011_0111, _, _) => {
            Instruction::U(instruction::U::from_instruction(instruction, opcode::U::LUI))
        }
        ...
        (0b001_0011, 0b000, _) => {
            Instruction::I(instruction::I::from_instruction(instruction, opcode::I::ADDI))
        }
        ...
        (0b001_0011, 0b100, _) => {
            Instruction::I(instruction::I::from_instruction(instruction, opcode::I::XORI))
        }
        (0b001_0011, 0b110, _) => {
            Instruction::I(instruction::I::from_instruction(instruction, opcode::I::ORI))
        }
        (0b001_0011, 0b111, _) => {
            Instruction::I(instruction::I::from_instruction(instruction, opcode::I::ANDI))
        }
        (0b001_0011, 0b001, 0b000_0000) => {
            Instruction::I(instruction::I::from_instruction(instruction, opcode::I::SLLI))
        }
        (0b001_0011, 0b101, 0b000_0000) => {
            Instruction::I(instruction::I::from_instruction(instruction, opcode::I::SRLI))
        }
        (0b001_0011, 0b101, 0b010_0000) => {
            Instruction::I(instruction::I::from_instruction(instruction, opcode::I::SRAI))
        }
        (0b011_0011, 0b000, 0b000_0000) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::ADD))
        }
        (0b011_0011, 0b000, 0b010_0000) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::SUB))
        }
        (0b011_0011, 0b001, 0b000_0000) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::SLL))
        }
        ...
        (0b011_0011, 0b100, 0b000_0000) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::XOR))
        }
        (0b011_0011, 0b101, 0b000_0000) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::SRL))
        }
        (0b011_0011, 0b101, 0b010_0000) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::SRA))
        }
        ...
        (0b011_0011, 0b111, 0b000_0000) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::AND))
        }
        (0b000_1111, 0b000, _) => {
            Instruction::IMem(instruction::IMem::from_instruction(instruction, opcode::IMem::FENCE))
        }
        ...
        (0b011_0011, 0b000, _) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::MUL))
        }
        (0b011_0011, 0b001, _) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::MULH))
        }
        (0b011_0011, 0b010, _) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::MULHSU))
        }
        (0b011_0011, 0b011, _) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::MULHU))
        }
        (0b011_0011, 0b100, _) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::DIV))
        }
        (0b011_0011, 0b101, _) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::DIVU))
        }
        (0b011_0011, 0b110, _) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::REM))
        }
        (0b011_0011, 0b111, _) => {
            Instruction::R(instruction::R::from_instruction(instruction, opcode::R::REMU))
        }
